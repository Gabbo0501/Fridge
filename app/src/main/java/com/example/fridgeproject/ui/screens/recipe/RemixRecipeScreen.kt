...
import com.example.fridgeproject.viewmodel.recipe.RemixRecipeUiState


@Composable
fun RemixRecipeScreen(
    modifier: Modifier = Modifier,

    uiState: RemixRecipeUiState,
    ...
    when{
        ...
        !uiState.errors.globalError.isNullOrBlank() -> {
            Text(
                text = uiState.errors.globalError,
            ...
            Column(
                ...
                Row(
                    ...
                    Text(
                        text = "Remixed from: ${uiState.remixedFromRecipeTitle}",
